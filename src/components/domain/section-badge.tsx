  ...
  "inline-flex h-5 w-fit shrink-0 items-center justify-center rounded-full px-2 py-0.5 text-xs font-medium whitespace-nowrap",
  {
    variants: {
      type: {
        ...
        interlude: "border border-dashed border-border text-muted-foreground",
        intro: "border border-border bg-muted/40 text-muted-foreground",
        outro: "border border-border bg-muted/70 text-muted-foreground",
